  ...
  return (
    <>
      <NextSeo
        ...
        description="Learn more about Nikunj Khitha, a dedicated FullStack and AI Developer. Discover the journey, skills, and passion that drive me to create innovative and user-friendly web solutions."
