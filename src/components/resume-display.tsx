  ...
  return (
    <FadeUp duration={0.6} delay={0.1} whileInView={true}>
      <div className={`${backgroundColor} border border-accent/20 rounded-2xl shadow-xl shadow-accent/10 p-6 md:p-8 lg:p-10 max-w-5xl mx-auto ${className}`}>
        {/* Header Section */}
        <FadeUp duration={0.5} delay={0.2} whileInView={true}>
        ...
        <FadeUp duration={0.5} delay={0.3} whileInView={true}>
          <section className="mb-8">
            ...
            <div className="grid gap-4 md:gap-6">
              {[
                ...
                <FadeUp key={skillGroup.category} duration={0.4} delay={0.4 + index * 0.1} whileInView={true}>
                  <div className={`${sectionBackgroundColor} rounded-xl p-4 md:p-5 border border-accent/10`}>
        ...
        <FadeUp duration={0.5} delay={0.5} whileInView={true}>
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-accent mb-6 flex items-center gap-3">
            ...
            <div className="space-y-6">
              {[
                ...
                <FadeUp key={index} duration={0.4} delay={0.6 + index * 0.1} whileInView={true}>
        ...
        {/* Projects Section */}
        <FadeUp duration={0.5} delay={0.7} whileInView={true}>
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-accent mb-6 flex items-center gap-3">
            ...
            <div className="space-y-6">
              {[
                ...
                <FadeUp key={index} duration={0.4} delay={0.8 + index * 0.1} whileInView={true}>
                  <div className={`${sectionBackgroundColor} rounded-xl p-6 md:p-8 border border-accent/10 hover:border-accent/30 transition-all duration-300 hover:shadow-lg hover:shadow-accent/10 group cursor-pointer`}>
        ...
        <FadeUp duration={0.5} delay={0.9} whileInView={true}>
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-accent mb-6 flex items-center gap-3">
        ...
        {/* Education */}
        <FadeUp duration={0.5} delay={1.0} whileInView={true}>
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-accent mb-6 flex items-center gap-3">
        ...
        {/* Navigation Links */}
        <FadeUp duration={0.5} delay={1.1} whileInView={true}>
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-accent mb-6 flex items-center gap-3">
              <ExternalLink className="text-accent" size={32} />
              Explore More
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <FadeUp key={link.href} duration={0.4} delay={1.2 + index * 0.1} whileInView={true}>
                  <Link 
                    href={link.href}
