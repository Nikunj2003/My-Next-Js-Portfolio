...
import NavigationIndicator, { useNavigationActions, NavigationAction } from '../navigation-indicator';
...
describe('NavigationIndicator', () => {
  ...
  it('renders active navigation actions', () => {
    render(<NavigationIndicator actions={mockActions} onDismiss={mockOnDismiss} />);
  ...
  it('displays progress bar for in-progress actions', () => {
    ...
    render(<NavigationIndicator actions={inProgressActions} onDismiss={mockOnDismiss} />);

    // Progress bar should be present for in-progress actions
    const progressBar = screen.getByText('Navigating to projects...').closest('div')?.querySelector('.bg-blue-500');
  ...
  it('calls onDismiss when dismiss button is clicked', () => {
    ...
    render(<NavigationIndicator actions={completedActions} onDismiss={mockOnDismiss} />);
  ...
  it('renders nothing when no active actions', () => {
    const { container } = render(<NavigationIndicator actions={[]} onDismiss={mockOnDismiss} />);
  ...
  it('handles different action types correctly', () => {
    ...
    render(<NavigationIndicator actions={differentActions} onDismiss={mockOnDismiss} />);
