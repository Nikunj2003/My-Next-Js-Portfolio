...
import { PageContextDetector, ContextTracker, PageContextDetection } from '../page-context-detector';
...
describe('PageContextDetector', () => {
  ...
  describe('detectFromUrl', () => {
    ...
    it('should detect projects page with section from URL', () => {
      const result = detector.detectFromUrl('https://example.com/projects/web-apps');
    ...
    it('should detect section from hash fragment', () => {
      const result = detector.detectFromUrl('https://example.com/about#experience');
  ...
  describe('detectFromChatMessage', () => {
    it('should detect about page from experience-related message', () => {
      const result = detector.detectFromChatMessage('Tell me about your work experience');
    ...
    it('should detect projects page from project-related message', () => {
      const result = detector.detectFromChatMessage('Show me your projects and portfolio');
    ...
    it('should detect contact page from contact-related message', () => {
      const result = detector.detectFromChatMessage('How can I contact you or send an email?');
    ...
    it('should detect resume page from resume-related message', () => {
      const result = detector.detectFromChatMessage('Can I download your resume PDF?');
    ...
    it('should detect skills section from skills-related message', () => {
      const result = detector.detectFromChatMessage('What programming languages and technologies do you know?');
    ...
    it('should increase confidence for multiple matches', () => {
      ...
      const result2 = detector.detectFromChatMessage('projects and portfolio work');
      
      expect(result2.confidence).toBeGreaterThan(result1.confidence);
    });

    it('should increase confidence for shorter messages with matches', () => {
      const result1 = detector.detectFromChatMessage('Tell me about your work experience and career background in detail');
  ...
  describe('detectFromNavigation', () => {
    it('should detect from navigation history', () => {
      ...
      expect(result.metadata?.navigationHistory).toEqual(['/home', '/about', '/projects']);
    });
    ...
    it('should limit navigation history in metadata', () => {
      ...
      expect(result.metadata?.navigationHistory).toEqual(['/4', '/5', '/projects']);
    });
  });
  ...
  describe('detectFromReferrer', () => {
    ...
    it('should have lower confidence than direct URL detection', () => {
      ...
      const referrerResult = detector.detectFromReferrer('https://example.com/about');
