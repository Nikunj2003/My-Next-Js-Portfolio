          ...
          <AnimatePresence>
            <FadeUp key="title-main" duration={0.6}>
              <div className="relative">
                <h1 className="bg-gradient-to-r from-accent via-accent-light to-accent bg-clip-text py-2 text-5xl font-bold text-transparent sm:text-6xl md:text-7xl xl:text-8xl">
                  Nikunj Khitha
                </h1>
                {/* Animated underline */}
                <motion.div
            ...
            <FadeUp key="stats" duration={0.6} delay={0.4}>
            ...
            <FadeUp key="cta-buttons" duration={0.6} delay={0.6}>
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                ...
                <Link href="/about">
                  <button className="rounded-full border-2 border-accent px-8 py-4 text-lg font-semibold text-accent transition-all duration-300 hover:bg-accent hover:text-white hover:scale-105 active:scale-95">
                    Learn More
                  </button>
                </Link>
              </div>
